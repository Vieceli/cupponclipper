...
from cuponclipper001.boleto import bancos
from cuponclipper001.boleto.util import gerar_codigo_barras
from io import StringIO
from cuponclipper001.boleto.bancos import BoletoBancoDoBrasil, BoletoBancoReal,\
            BoletoBradesco, BoletoCaixaEconomica, BoletoCaixaEconomicaSIGCB
from cuponclipper001.cupon.models import Localizacao, Cupon
from cuponclipper001.cupon.views import _cidade_cliente

def boleto_bb(request, cidade_slug, cupon_slug):
...
def boleto_bradesco(request):
    ...
    dados['carteira'] = '06'            # Codigo da Carteira: pode ser 06 ou 03
