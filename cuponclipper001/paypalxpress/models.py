...
class PayPalResponse(models.Model):
    ...
    def get_default_status():
        ps, created = PayPalResponseStatus.objects.get_or_create(summary = _("Auth"))  #xxx
        return ps
    ...
    def fill_from_response(self, response, action = "Auth"):
        """
        For payment:
        ...
        if action == "Sale" or action == "Auth": #xxx
